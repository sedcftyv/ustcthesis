...
带DBC模型的神经压缩模型优化结束后，需要使用NVTT对神经纹理进行DXT格式压缩，
以导出DXT格式纹理进行测试，以验证DBC模型的有效性。
...
\subsubsection{对比实验}
\label{3:对比实验}
6个材质的纹理集上进行的实验结果如图表\ref{6个材质的纹理集上进行的实验结果}所示，
...
\begin{table*}[htbp]
    \centering
    \caption{6个材质的纹理集上进行的实验结果}
    \label{6个材质的纹理集上进行的实验结果}        
    \resizebox{\linewidth}{!}{
    \begin{tabular}{ccccccccccccccccccc}
        ...
        DBC7s     & 30.2512  & 0.8221  & 0.1087 & 30.602  & 0.8683  & 0.0919 & 30.8006 & 0.8338  & 0.1068  & 29.6132 & 0.8223 & 0.1378 & 26.6591 & 0.1671 & 0.6551 & 31.8172 & 0.0986 & 0.9084  \\
        DBC7      &          &         &        &         &         &        &         &         &         &         &        &        &         &        &        &         &        &         \\
        \bottomrule
\end{tabular} }   
\end{table*}
