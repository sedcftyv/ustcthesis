...
\begin{table*}[htbp]
    ...
    \begin{tabular}{ccccccccccccccccccc}
        ...
        & \multicolumn{3}{c}{Ukulele\_01} & \multicolumn{3}{c}{antique\_katana\_01} & \multicolumn{3}{c}{utility\_box\_02} & \multicolumn{3}{c}{chinese\_chandelier} & \multicolumn{3}{c}{dartboard} & \multicolumn{3}{c}{Drill\_01}\\
                  ...
                  DBC6      & \textbf{27.083}   & \textbf{0.7622}  & \textbf{0.1707} & \textbf{27.9227} & \textbf{0.8233}  & \textbf{0.1322} & \textbf{28.0362} & \textbf{0.7877}  & \textbf{0.1453}  & \textbf{25.8831} & \textbf{0.7453} & \textbf{0.2163} & \textbf{23.9072} & \textbf{0.5989} & \textbf{0.2245} & \textbf{26.8316} & \textbf{0.8295}  & \textbf{0.1693}   \\
                  \midrule
                  ...
                  DBC7      & \textbf{30.534}   & \textbf{0.8277}  & \textbf{0.1018} & \textbf{30.8209} & \textbf{0.8736}  & \textbf{0.0871} & \textbf{31.154}  & \textbf{0.8412}  & \textbf{0.0998}  & \textbf{29.9482} & \textbf{0.8297} & \textbf{0.1294} & \textbf{26.8479} & \textbf{0.6582} & \textbf{0.1643} & \textbf{33.2971} & \textbf{0.9305} & \textbf{0.0783}   \\
        \bottomrule
\end{tabular} }   
\end{table*}
